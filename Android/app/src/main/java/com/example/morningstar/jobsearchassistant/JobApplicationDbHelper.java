...
public class JobApplicationDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        final String SQL_CREATE_TABLE_JOB_APPLICATION = "CREATE TABLE "+
                ...
                JobApplicationContract.JobApplication.COLUMN_JOB_STATUS + " INTEGER, "+
                JobApplicationContract.JobApplication.COLUMN_PENDING_ACTION + " INTEGER, "+
                ...
                JobApplicationContract.JobApplication.COLUMN_JOB_POSITION_TYPE +" INTEGER, "+
